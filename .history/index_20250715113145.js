...
const { redirectShortUrl, createShortUrl } = require('./controllers/shortUrlController'); // Import short url controllers
const authenticateApp = require('./middleware/authenticateApp'); // Import authenticate app middleware
...
(async () => {
  ...
  // Short URL creation route (protected by authenticateApp middleware)
  app.post('/shorten', authenticateApp, createShortUrl);
